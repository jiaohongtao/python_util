"""
https://blog.csdn.net/m0_48405781/article/details/107181516
"""
...
def img2Cartoon(img):
    ...
    if response:
        # 打开一个文件
        f = open('../no_upload/karton_photo.png', 'wb')
        # 获取动漫头像
...
if __name__ == '__main__':
    # img2Cartoon('../images/zhoujielun.png')
    img2Cartoon('../no_upload/images/sheep.jpg')
    print("生成咯")
